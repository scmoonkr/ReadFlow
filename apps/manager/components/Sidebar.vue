...
import { managerMenu } from "~/config/menu";
...
<template>
  <aside class="sidebar">
    <div class="brand">
      ReadFlow
      <small>시스템 운영 · Platform</small>
    </div>
    <nav class="nav" aria-label="운영 메뉴">
      <NuxtLink
...
@media (max-width: 1024px) {
  .sidebar { position: fixed; z-index: 60; width: var(--sidebar-w); transform: translateX(-100%); transition: transform 0.2s; }
